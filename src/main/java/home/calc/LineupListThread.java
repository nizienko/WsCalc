...
public class LineupListThread extends Thread {
    ...
    public LineupListThread(Team team, Integer minStr, Integer physic, String[] formations, Roster roster){
        ...
        for (Positions[] formation: positions) {
            ...
            if (interestingFormation) {
                ...
                while (found < 10 & str > minStr){
                    ...
                    System.out.println(typeFormation + " Всего возможно вариантов " + count+", для игроков силой не меньше "+str);
                    ...
                    System.out.println("Всего " + this.allLineups.size() + " Согласно расстановке " + found);
                    str--;
                }
